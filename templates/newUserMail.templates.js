          ...
          <td valign="middle" class="hero bg_white" style="padding: 0 0 1em 0;">
            <table>
				<tr>
                   ...
                   <!-- <tr> 
					   <img src="http://res.cloudinary.com/damaged/image/upload/v1650878216/Damaged-1650878207994.jpg" alt="" style="width: 300px; max-width: 600px; height: auto; margin: auto; display: block;">
                </tr> -->
            	<tr>
            		...
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: left;">
							...
							<h4>A new user - <a href="${process.env.APP_URL}/user/one?id=${user_id}"><b>${user}</b></a> just registered on Gloed, head over to your dashboard to see more about this user. </h4>
							<h5>
